namespace Marvel
{
    ...
    public interface IMarvel
    {
        ...
        Task<string> GetCharacterComicsJson(int characterId, CancellationToken token);
        Task<MarvelResponse<Comic>> GetCharacterComics(int characterId, CancellationToken token);
    }
}